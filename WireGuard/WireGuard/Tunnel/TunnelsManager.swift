...
public protocol TunnelsManagerListDelegate: class {
...
public protocol TunnelsManagerActivationDelegate: class {
...
public class TunnelContainer: NSObject {
    ...
    @objc public dynamic var isActivateOnDemandEnabled: Bool
    ...
    open var tunnelProvider: NETunnelProviderManager
